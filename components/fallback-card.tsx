...
export function FallbackCard({
  message = "I'm not confident enough to answer that from the available documentation. Please contact human support."
}: FallbackCardProps) {
  return (
    <Card className="mt-5 rounded-2xl border-amber-300/[0.15] bg-amber-400/[0.08] p-4 shadow-none">
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-semibold text-amber-50">Low-confidence safeguard</p>
